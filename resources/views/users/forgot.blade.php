                ...
                <div class="navbar-header">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown topbar-head-dropdown ms-1 header-item me-3">
                            <a type="button" href="14-oe-login.html" class="btn btn-soft-info waves-effect waves-light">
                                Log in
                            </a>
                        </div>

                        <div class="dropdown topbar-head-dropdown ms-1 header-item">
                            <a type="button" href="15-oe-signup.html"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-9 col-lg-8 col-xl-6">
                            <div class="card mt-4">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6 text-center">
                                        <a type="button" href="17-oe-forgetpwd-pgp.html"
                                            class="btn btn-secondary btn-animation waves-effect waves-light w-50"
                                            data-text="PGP"><span>PGP</span>
                                        </a>
                                    </div>
                                    <div class="col-md-6 text-center">
                                        <a type="button" href="18-oe-forgetpwd-mnemonic.html"
                                            class="btn btn-secondary btn-animation waves-effect waves-light w-50"
                                            data-text="MNENMONIC"><span>MNENMONIC</span>
                                        </a>
                                    </div>
                                </div>
                                <!-- end card body -->
                            ...
                            <div class="mt-4 text-center">
                                <p class="mb-0">Don't want to change password? <a href="14-oe-login.html"
